// Dafny program Tokeneer2.dfy compiled into C#
...
public class @Token {
  public BigInteger @fingerprint = BigInteger.Zero;
  public BigInteger @clearanceLevel = BigInteger.Zero;
  public bool @valid = false;
  public void @Init(BigInteger @fingerprint, BigInteger @clearanceLevel)
  {
  TAIL_CALL_START: ;
    var _this = this;
    (_this).@fingerprint = @fingerprint;
    (_this).@clearanceLevel = @clearanceLevel;
    (_this).@valid = true;
  }
  public bool @ValidateFingerPrint(BigInteger @scannedFingerprint) {
    return ((this).@fingerprint) == (@scannedFingerprint);
  }
}

public class @Door {
  public BigInteger @requiredClearanceLevel = BigInteger.Zero;
  public void @Init(BigInteger @requiredClearanceLevel)
  {
  TAIL_CALL_START: ;
    var _this = this;
    (_this).@requiredClearanceLevel = @requiredClearanceLevel;
  }
  public void @EnterDoor(@User @user, out bool @accessGranted)
  {
    @accessGranted = false;
  TAIL_CALL_START: ;
    var _this = this;
    if (((@user).@token).@valid)
    {
      bool @_72_validFingerPrint = false;
      @_72_validFingerPrint = ((@user).@token).@ValidateFingerPrint((@user).@ScanFinger());
      if (!(@_72_validFingerPrint))
      {
        ((@user).@token).@valid = false;
        @accessGranted = false;
        return;
      }
      @accessGranted = (_this).@ValidateClearanceLevel((@user).@token);
    }
    else
    {
      @accessGranted = false;
  ...
  public bool @ValidateClearanceLevel(@Token @token) {
    return ((@token).@clearanceLevel) >= ((this).@requiredClearanceLevel);
  }
}
...
public class @User {
  ...
  public BigInteger @fingerprint = BigInteger.Zero;
  public void @Init(BigInteger @fingerprint)
  {
  TAIL_CALL_START: ;
    var _this = this;
    (_this).@fingerprint = @fingerprint;
    (_this).@token = (@Token)null;
  }
  public BigInteger @ScanFinger() {
    return (this).@fingerprint;
  }
}

public class @EnrolmentStation {
  public Dafny.Set<@User> @users = Dafny.Set<@User>.Empty;
  public void @Init()
  {
  TAIL_CALL_START: ;
    var _this = this;
    (_this).@users = Dafny.Set<@User>.FromElements();
  }
  public void @Enrol(@User @user, BigInteger @clearanceLevel, BigInteger @fingerPrint)
  {
  TAIL_CALL_START: ;
    var _this = this;
    var _nw0 = new @Token();
    @_nw0.@Init(@fingerPrint, @clearanceLevel);
    (@user).@token = _nw0;
    (_this).@users = ((_this).@users).@Union(Dafny.Set<@User>.FromElements(@user));
  }
}

public class @__default {
  public static BigInteger @HIGH() {
    return new BigInteger(3);
  }
  public static BigInteger @MEDIUM() {
    return new BigInteger(2);
  }
  public static BigInteger @LOW() {
    return new BigInteger(1);
  }
  public void @PrintAccess(bool @accessGranted, bool @tokenValid)
  {
  TAIL_CALL_START: ;
    var _this = this;
    if (@accessGranted)
    {
      System.Console.Write(Dafny.Sequence<char>.FromString("Access granted!\n\n"));
    }
    else
    {
      System.Console.Write(Dafny.Sequence<char>.FromString("Access denied!\n"));
      if (!(@tokenValid))
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("Token invalid!\n\n"));
      }
      else
      {
  ...
  TAIL_CALL_START: ;
    var _this = this;
    @EnrolmentStation @_73_enrolmentStation = (@EnrolmentStation)null;
    var _nw1 = new @EnrolmentStation();
    @_nw1.@Init();
    @_73_enrolmentStation = _nw1;
    @Door @_74_doorHigh = (@Door)null;
    var _nw2 = new @Door();
    @_nw2.@Init(@__default.@HIGH());
    @_74_doorHigh = _nw2;
    @Door @_75_doorMedium = (@Door)null;
    var _nw3 = new @Door();
    @_nw3.@Init(@__default.@MEDIUM());
    @_75_doorMedium = _nw3;
    @Door @_76_doorLow = (@Door)null;
    var _nw4 = new @Door();
    @_nw4.@Init(@__default.@LOW());
    @_76_doorLow = _nw4;
    @User @_77_userHigh1 = (@User)null;
    var _nw5 = new @User();
    @_nw5.@Init(new BigInteger(1));
    @_77_userHigh1 = _nw5;
    @User @_78_userHigh2 = (@User)null;
    var _nw6 = new @User();
    @_nw6.@Init(new BigInteger(2));
    @_78_userHigh2 = _nw6;
    @User @_79_userMedium3 = (@User)null;
    var _nw7 = new @User();
    @_nw7.@Init(new BigInteger(3));
    @_79_userMedium3 = _nw7;
    @User @_80_userMedium4 = (@User)null;
    var _nw8 = new @User();
    @_nw8.@Init(new BigInteger(4));
    @_80_userMedium4 = _nw8;
    @User @_81_userLow5 = (@User)null;
    var _nw9 = new @User();
    @_nw9.@Init(new BigInteger(5));
    @_81_userLow5 = _nw9;
    @User @_82_userLow6 = (@User)null;
    var _nw10 = new @User();
    @_nw10.@Init(new BigInteger(6));
    @_82_userLow6 = _nw10;
    (@_73_enrolmentStation).@Enrol(@_77_userHigh1, @__default.@HIGH(), new BigInteger(1));
    { }
    { }
    { }
    (@_73_enrolmentStation).@Enrol(@_78_userHigh2, @__default.@HIGH(), new BigInteger(2));
    { }
    { }
    { }
    (@_73_enrolmentStation).@Enrol(@_79_userMedium3, @__default.@MEDIUM(), new BigInteger(3));
    { }
    { }
    { }
    (@_73_enrolmentStation).@Enrol(@_80_userMedium4, @__default.@MEDIUM(), new BigInteger(4));
    { }
    { }
    { }
    (@_73_enrolmentStation).@Enrol(@_81_userLow5, @__default.@LOW(), new BigInteger(5));
    { }
    { }
    { }
    (@_73_enrolmentStation).@Enrol(@_82_userLow6, @__default.@LOW(), new BigInteger(6));
    { }
    { }
    { }
    bool @_83_accessGranted = false;
    bool _out11;
    (@_74_doorHigh).@EnterDoor(@_77_userHigh1, out _out11);
    @_83_accessGranted = _out11;
    { }
    { }
    bool _out12;
    (@_74_doorHigh).@EnterDoor(@_78_userHigh2, out _out12);
    @_83_accessGranted = _out12;
    { }
    { }
    bool _out13;
    (@_74_doorHigh).@EnterDoor(@_79_userMedium3, out _out13);
    @_83_accessGranted = _out13;
    { }
    { }
    bool _out14;
    (@_74_doorHigh).@EnterDoor(@_80_userMedium4, out _out14);
    @_83_accessGranted = _out14;
    { }
    { }
    bool _out15;
    (@_74_doorHigh).@EnterDoor(@_81_userLow5, out _out15);
    @_83_accessGranted = _out15;
    { }
    { }
    bool _out16;
    (@_74_doorHigh).@EnterDoor(@_82_userLow6, out _out16);
    @_83_accessGranted = _out16;
    { }
    { }
  }
